...
router.post("/conversation/:conversationId", optionalAuth, async (req, res) => {
  ...
  // If a human agent replied, and the conversation's inbox is a connected
  // Meta channel (Messenger/Instagram/WhatsApp), push the reply out to the customer.
  ...
  // If the incoming message is from the contact/customer, and this inbox has
  // an AI agent (Dify or custom) configured with autoReply on, ask it for a reply.
